...
public class RestfulBookmarkServiceTest {
	...
	public void setUp() throws Exception {
		...
		((RestfulBookmarkServiceImpl) this.service).setBookmarkService(bookmarkService);
		((RestfulBookmarkServiceImpl) this.service).setConversionService(conversionService);
		((RestfulBookmarkServiceImpl) this.service).setCurrentTimeProvider(currentTimeProvider);
